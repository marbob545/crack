	...
	def connect(self,tupple,ssl=False):
		...
		#	print rez
			...
			if rez[0:3]!='250':
				...
				s.close()
				return self.addBad(host1)
			rez=self.sendCmd(s,"MAIL FROM: <salemmo5tar@outlook.com>")
			...
			headers='From: "JayDin SMTP" <salemmo5tar@outlook.com>\r\n'
			headers+='To: '+email+'\r\n'
			...
			headers+='Return-Path: salemmo5tar@outlook.com\r\n'
